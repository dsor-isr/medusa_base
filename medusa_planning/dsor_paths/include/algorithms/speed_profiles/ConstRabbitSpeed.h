 ...
 *  @copyright MIT
 */
class ConstRabbitSpeed : public Speed {
  ...
  public:
     ...
     *
     * @param rabbit_speed  The speed of the path parameter (in the path frame)
     * @param default_val  The default value of the path parameter (if outside the parameterization bounds)
     */
