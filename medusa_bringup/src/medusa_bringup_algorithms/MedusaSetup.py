...
from medusa_msgs.msg import ProcessState
from medusa_msgs.srv import ManageProcess
...
class MedusaSetup:
    ...
    def __init__(self, vehicle_name, launch_type, gazebo):
        ...
        self.process_state_publisher = rospy.Publisher(
            '/' + self.vehicle_name + '/process_state', ProcessState, queue_size=1)
        ...
        self.manage_process_server = rospy.Service(
            '/' + self.vehicle_name + '/manage_process', ManageProcess, self.callback_manage_process)
